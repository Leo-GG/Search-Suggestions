/**
* @file ComparatorInvFreq.java
* @brief Contiene la clase ComparatorFreq
*
* Este archivo contiene la implementacion de un comparador de objetos Query
* que permite ordenarlos por orden decreciente de frecuencia en primer lugar y 
* por orden lexicografico creciente en segundo lugar.
* Implementa el interfaz ComparatorIF
*/

/**
* @class ComparatorInvFreq
* Clase que contiene los metodos para comparar dos objetos de tipo Query
* por orden decreciente de frecuencia (1) y creciente lexicografico (2)
*/
public class ComparatorInvFreq implements ComparatorIF<Query>
{
