/**
* @file QueueIterator.java
* @brief Contiene la implementacion de un iterador generico para colas
*
* Este archivo contiene la implementacion de un iterador generico para colas
*/
